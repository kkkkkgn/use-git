            ...
            <div class="card-body">
              <form>
                <div class="form-group" style="text-align: center;">
                  ...
                  <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=aaba8bc0f5ce9905fbf2c416825307d8&redirect_uri=http://192.168.133.1:8080/login_ok.do">
            ...
            <div class="card-body">
              <form>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="adminUsername" placeholder="아이디를 입력해주세요.">
                </div>
                <div class="form-group">
                  <label for="adminPassword">비밀번호</label>
                  <input type="password" class="form-control" id="adminPassword" placeholder="비밀번호를 입력해주세요.">
                </div>
                <button type="button" class="btn btn-primary Btn-login"><a href="./index.html" class="text-white">Log in</a></button>
              </form>
            </div>
          </div>
