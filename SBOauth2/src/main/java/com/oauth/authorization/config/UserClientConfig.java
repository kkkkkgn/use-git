...
public class UserClientConfig {
	...
	@Bean
	public UserClient welcomeClient(OAuth2AuthorizedClientManager authorizedClientManager) throws Exception {
		return httpServiceProxyFactory(authorizedClientManager).createClient(UserClient.class);
	}
